...
--
-- Name: emp_cust_relation; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.emp_cust_relation AS
 SELECT customers.customername,
    TRIM(BOTH FROM concat(employees.firstname, ' ', employees.lastname)) AS employeename
   FROM public.customers,
    public.employees
  WHERE (customers.salesrepemployeenumber = employees.employeenumber);


ALTER TABLE public.emp_cust_relation OWNER TO postgres;
...
--
-- Name: name_first_line_address; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.name_first_line_address AS
 SELECT concat(employees.firstname, ' ', employees.lastname) AS concat,
    offices.addressline1
   FROM public.employees,
    public.offices
  WHERE ((employees.officecode)::text = (offices.officecode)::text);


ALTER TABLE public.name_first_line_address OWNER TO postgres;
...
--
-- Name: num_of_product_sold; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.num_of_product_sold AS
 SELECT products.productname,
    sum(orderdetails.quantityordered) AS sum
   FROM ((public.products
     JOIN public.orderdetails ON (((products.productcode)::text = (orderdetails.productcode)::text)))
     JOIN public.orders ON (((orderdetails.ordernumber = orders.ordernumber) AND ((orders.status)::text = 'Shipped'::text))))
  GROUP BY products.productname;


ALTER TABLE public.num_of_product_sold OWNER TO postgres;
...
--
-- Name: payment_from_september; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.payment_from_september AS
 SELECT payments.customernumber,
    payments.checknumber,
    payments.paymentdate,
    payments.amount
   FROM public.payments
  WHERE (payments.paymentdate >= '2021-09-01'::date);


ALTER TABLE public.payment_from_september OWNER TO postgres;
...
1002	MurphyModified	Diane	x5800	dmurphy@classicmodelcars.com	1	\N	President
\.
...
10164	2019-10-21	2019-10-30	2019-10-23	Shipped	This order was disputed, but resolved on 11/1/2003; Customer doesnt like the colors and precision of the models.	452
...
S10_1678	1969 Harley Davidson Ultimate Chopper	Motorcycles	1:10	Min Lin Diecast	This replica features working kickstand, front suspension, gear-shift lever, footbrake lever, drive chain, wheels and steering. All parts are particularly delicate due to their precise scale and require special care and attention.	7932	48.81	95.70
S72_3223	test_product	Ships	1:70	Test	TEST	2	2.10	2.30
S72_3225	test_product_2	Ships	1:70	Test	TEST	2	2.10	2.30
\.
...
GRANT SELECT ON TABLE public.customers TO courier;
...
--
-- Name: TABLE emp_cust_relation; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.emp_cust_relation TO head_office;


--
-- Name: TABLE name_first_line_address; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.name_first_line_address TO hrd;
...
GRANT SELECT,UPDATE ON TABLE public.orders TO courier;
...
--
-- Name: TABLE num_of_product_sold; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.num_of_product_sold TO sales;


--
-- Name: TABLE payment_from_september; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.payment_from_september TO accountant;


--
-- Name: TABLE productlines; Type: ACL; Schema: public; Owner: postgres
--

GRANT SELECT ON TABLE public.productlines TO business_intelligence;
